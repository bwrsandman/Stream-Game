...
>>>>>>> 92f4db9f6efe60461ff14b90269314a32f178068
...
<<<<<<< HEAD
	...
	Category
	{
		...
		Pass
		{
				// The material tag, used to set material variables to OpenGL
				Material
				{
					Diffuse [_Color]
					Ambient [_Color]
				...
				SeparateSpecular On				// Use the SeperateSpecular option, so spec isseperated from the texture itself
