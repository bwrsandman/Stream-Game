...
//Last modified: Mon, Mar 11, 2013 05:21:34 PM
//Codeset: 1252
requires maya "2013";
...
createNode mesh -n "BarrelShape" -p "Barrel";
	...
	setAttr ".vs" 5;
	setAttr ".bw" 3;
createNode mesh -n "polySurfaceShape1" -p "Barrel";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.1740916992473398 2.1486349343796554 2.5478764549646651 ;
	setAttr ".r" -type "double3" -19.538352729599097 58.599999999996648 3.0522993118449966e-015 ;
...
createNode polyExtrudeFace -n "polyExtrudeFace1";
	...
	setAttr ".ix" -type "matrix" 0.34804815980062453 0 0 0 0 0.41321557889636046 0 0
		 0 0 0.34804815980062453 0 0 0.41321557889636046 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 0 0.52695793 0 ;
	setAttr ".rs" 55474;
	setAttr ".lt" -type "double3" -5.2041704279304213e-017 1.0408340855860843e-016 0.050344304283216838 ;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -0.40186807258794016 0.41321557889636046 -0.40186807258794016 ;
	setAttr ".cbx" -type "double3" 0.40186807258794016 0.6407002274135446 0.40186807258794016 ;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "polyExtrudeFace1.out" "BarrelShape.i";
