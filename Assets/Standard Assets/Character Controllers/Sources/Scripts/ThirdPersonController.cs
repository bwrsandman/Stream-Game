...
public class ThirdPersonController : MonoBehaviour {
	...
	private float lockCameraTimer = 0.2f;
	...
	void UpdateSmoothedMovementDirection ()
	{
		...
		float v = Input.GetAxisRaw("Vertical Move");
	...
	bool IsMoving()
	{
		return Mathf.Abs(Input.GetAxisRaw("Vertical Move")) + Mathf.Abs(Input.GetAxisRaw("Horizontal Move")) > 0.5f;
	}
